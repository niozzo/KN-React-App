/**
 * Test useSessionData without AuthContext dependency
 */

import { describe, it, expect, vi, beforeEach, afterEach } from 'vitest';
import { renderHook, act } from '@testing-library/react';
import { useSessionData, injectServices, resetServices } from '../../hooks/useSessionData-testable-no-auth';

describe('useSessionData No Auth Test', () => {
  const mockSessions = [
    {
      id: '1',
      title: 'Test Session',
