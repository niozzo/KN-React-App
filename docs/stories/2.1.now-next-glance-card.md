...
## Tasks / Subtasks
- [x] Task 1: Create Now/Next card components (AC: 1, 6) ✅ **UI SHELL COMPLETE**
...
- [ ] Task 9: Implement TDD for Now/Next card system (AC: 15-18)
  - [ ] Write unit tests for Now/Next card components and countdown logic (80% line coverage)
  - [ ] Write integration tests for data updates, user interactions, and real-time updates (70% branch coverage)
  - [ ] Write PWA offline tests for cached data and revalidation scenarios
  - [ ] Write edge case tests for between sessions, last session, no assignments
