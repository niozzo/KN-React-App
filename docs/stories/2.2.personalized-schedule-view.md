...
- [ ] Task 4: Implement data integration (AC: 1, 9)
  - [ ] **REUSE**: Leverage existing `useSessionData` hook with dining integration
  - [ ] **REUSE**: Inherit all Supabase real-time update functionality
  - [ ] **REUSE**: Utilize existing caching and offline support
  - [ ] **REUSE**: Inherit error handling and data synchronization
  - [ ] **REUSE**: Leverage existing seat assignment display from SessionCard
  - [ ] **NEW**: Add schedule-specific data filtering and sorting
