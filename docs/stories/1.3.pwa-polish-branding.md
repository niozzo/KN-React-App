...
- **Login Screen**: Install button prominently displayed for new users
...
1. Implement custom PWA install button on login screen
2. Implement custom PWA install button on home screen (under "View Full Schedule")
3. Add iOS Safari detection and instructions
4. Handle Chrome/Edge beforeinstallprompt API
5. Create cross-platform install experience
6. Test install button on all devices
